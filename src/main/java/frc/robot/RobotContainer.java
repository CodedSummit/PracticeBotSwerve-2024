...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    m_driverController.axisGreaterThan(2, 0.5)
      ...
      m_driverController.y()
      .onTrue(new SequentialCommandGroup(new InstantCommand(()-> swerveSubsystem.noop(),swerveSubsystem),
       new InstantCommand(()-> swerveSubsystem.setDefaultCommand(pointingSwerveJoystickCmd))))
      .onFalse(new SequentialCommandGroup(new InstantCommand(()-> swerveSubsystem.noop(),swerveSubsystem),
      new InstantCommand(()-> swerveSubsystem.setDefaultCommand(swerveJoystickCmd))));
/* 
